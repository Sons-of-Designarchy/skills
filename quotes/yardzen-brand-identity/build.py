...
PROBLEM = sheet('''  <div class="sec">Why now</div>
  ...
  <p>Yardzen delivers world-class landscape design every week. The brand around it does not present at that level, and you have already connected that gap to revenue: <b>more brand quality means more leads and more design purchases.</b></p>
  <div class="line"></div>
...
SEP29 = sheet('''  <div class="sec">Phase 1 · Foundations</div>
  ...
  <div class="line"></div>
  <div class="numrow"><div class="n">01</div><div class="t"><b>Mission</b>Who Yardzen is for and what it is for.</div></div>
...
DELIVERABLES_3 = sheet('''  <div class="sec">Deliverables · Phase 3</div>
  ...
  <p class="tnote"><b>What "one template per surface" means.</b> Each is a complete, specified, editable design: the pattern every future piece on that surface is built from. It is not every size, format or variant a surface will eventually need. Additional templates are $2,500 each and are natural Q1 work.</p>
  <div class="line"></div>
...
FITS = sheet('''  <div class="sec">How it fits</div>
  ...
  <p>Through the build we align the <b>structure</b> of the design tokens to the incoming brand and flag conflicts. We do not restyle the product against a system still under review, because applying it early means doing it twice.</p>
  <p>That adoption is what Q1 is for. It lands in the product once it is approved, not while it is being decided.</p>
  <div class="line"></div>
...
def CLOSE(final_line):
  ...
  <h2 class="big">A brand book that is delivered and not adopted has changed nothing.</h2>
